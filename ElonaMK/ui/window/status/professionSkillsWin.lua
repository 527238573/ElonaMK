...
--先声明本体
local professionSkillsWin = {name = tl("专业技能","Profession Skills"),icon_index = 11}


local skill_List = {"blacksmithing","mechanics","fabrication","alchemy","tailoring","jeweler","cooking","gardening","fishing","performer",}
...
function professionSkillsWin.keyinput(key)
...
function professionSkillsWin.win_open()
end

function professionSkillsWin.win_close()
  
end


function professionSkillsWin.window_do(dt,s_win)

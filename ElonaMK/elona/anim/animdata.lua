...
local function loadNewAnim()
  local linkF,indexList = data.LoadCVS("unitAnim","data/unit/anim_unit.csv",nil)
  ...
  for i=1,#indexList do
    ...
    dataT.img = love.graphics.newImage(picbase..file) --读取img
    ...
    for i= 1,w do
      for j=1,h do
        table.insert(dataT.__source,love.graphics.newQuad(dataT.w*(i-1),dataT.h*(j-1),dataT.w,dataT.h,imgw,imgh))
      end
    end
  end
